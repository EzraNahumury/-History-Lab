...
Anna AI-Native App Hackathon
If AI demos always stop at a chatbot or prompt, what comes next?

This hackathon is about building small, useful AI-native app prototypes on Anna.

Anna is an AI app runtime and developer platform where humans and AI can work together through app UI, tools, state, permissions, and human review. You do not need to learn a new programming language.

Build one focused workflow: a productivity tool, research assistant, creative workspace, game, automation flow, developer tool, or something new.

You do not need to ship a full production product. Build a focused Anna App prototype: one clear workflow, one working interaction, and a meaningful use of AI.

Prize
$300 Winner Takes All. Focused ideas and working demos matter more than size.

Prize pool note: The $300 winner-takes-all prize is provided directly by the Anna team as the hackathon organizer. It is not sponsored by a third party.

What To Build
More than a static page, more than a plain chatbot. Show AI participating through a workflow, tool call, generation step, structured UI, saved state, or human review.

Start with a simple App UI using HTML, CSS, JS, or React. Add tools and state only where they help.

Why It's Easy To Build
Anna handles the platform layer: app runtime, tool calling, permissions, local development, and a path to distribution. You can start with a lightweight HTML/CSS/JS or React UI, then add Tools, Skills, and state only where they help.

How To Start
Register for the hackathon.
Join Discord for starter docs, templates, and build support.
Pick one everyday workflow.
Build a small working demo.
Submit your project by the deadline.
What To Submit
Your Anna App or project artifact: shareable Anna App, runnable project, zip, private repo, or local run instructions.
A short project description: what you built, who it is for, how AI is used, and how it connects to Anna.
Optional short demo video.
Judging Criteria
Usefulness and user value
Working demo
Meaningful use of AI
Fit with Anna
Creativity and execution
Timeline
Jun 15: Kickoff and build week begins
Jun 22, 11:59 PM ET: Final submission deadline
Jun 23: Judging and winner announcement
Who Can Join
Open to everyone, worldwide. Build solo or in a team of up to 5.

Starter Resources
New to Anna? Start here:

Developer Hub: https://anna.partners/developers
Runnable examples: https://github.com/whtcjdtc2007/anna-executa-examples
Concepts: https://anna.partners/developers/overview/concepts
Join Discord if you want help choosing an idea, finding teammates, or getting unstuck:

https://discord.gg/HFVNePGS9
